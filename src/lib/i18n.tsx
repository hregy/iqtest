...
const STR: Record<string, { en: string; fa: string }> = {
  ...
  speed_iq_score: { en: "Speed IQ Score", fa: "امتیاز آی‌کیو سرعتی" },
  speed_iq_note: { en: "Speed-based game score — rewards fast, accurate answers", fa: "امتیاز بازیِ سرعتی — پاسخ‌های سریع و درست را پاداش می‌دهد" },
  sb_sub_quick_speed: { en: "Quick test — Speed IQ Score (accuracy + speed)", fa: "آزمون سریع — امتیاز آی‌کیو سرعتی (دقت + سرعت)" },
